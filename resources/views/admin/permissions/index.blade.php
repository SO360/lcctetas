...
@section('content')
    <h3 class="page-title">Permiso</h3>
    <p>
        <a href="{{ route('admin.permissions.create') }}" class="btn btn-success">Agregar</a>
    </p>
                    ...
                    @if (count($permissions) > 0)
                        @foreach ($permissions as $permission)
                            <tr data-entry-id="{{ $permission->id }}">
                                ...
                                <td>
                                    <a href="{{ route('admin.permissions.edit',[$permission->id]) }}" class="btn btn-xs btn-info">Editar</a>
                                    {!! Form::open(array(
